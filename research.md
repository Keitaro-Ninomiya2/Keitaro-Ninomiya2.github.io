...
[Google Scholar](https://scholar.google.com/citations?user=loahSo8AAAAJ)

### Working Papers

**[Reshuffling University Access: Analyzing Grade Distributions in the Absence of Standardized Testing](https://www.dropbox.com/scl/fi/7we8wwl1abx47vjtfhps5/Keitaro_JMP_final.pdf?rlkey=xoz14z55ycpzd010twp8az39l&st=zxydn9yl&dl=0)** — Job Market Paper
...
**[The Long-Term Impact of Workplace Diversification: Historical Evidence from Personnel Records](https://www.dropbox.com/scl/fi/vwl5t8eor7lflkct62djl/Tokyo_Diversity.pdf?rlkey=8onem5zuwquv38upoirj4i9zj&st=eq8nsz3b&dl=0)** (with Yuya Aikawa)
...
**[The Effectiveness of Taxes on Two-Sided Markets: Evidence from Ride-Hailing in Chicago](https://www.dropbox.com/scl/fi/m75xen6f4x0qlfd8uukfk/Taxation_on_Platforms__Evidence_from_congestion_tax_on_ridehailing.pdf?rlkey=lsibd3a8hklw6tufhr2k9h6yu&st=ouo027gv&dl=0)**
...
**[Chasing the sun and catching the wind: Energy transition and electricity prices in Europe](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4278476)** (with Serhan Cevik)  
*Journal of Economics and Finance* 47(4), 912-935, 2023. IMF Working Paper.

European power markets are in the midst of unprecedented changes, with a record-breaking surge in energy prices. This paper investigates the impact of green power resources on the level and volatility of wholesale electricity prices at a granular level, using monthly observations for a panel of 24 European countries over the period 2014–2021 and alternative estimation methods including a panel quantile regression approach. We find that renewable energy is associated with a significant reduction in wholesale electricity prices in Europe, with an average impact of 0.6 percent for each 1 percentage point increase in renewable share. We also find evidence for a nonlinear effect—that is, the higher the share of renewables, the greater its effect on electricity prices. On the other hand, while quantile estimation results are mixed with regards to the impact of renewables on the volatility of electricity prices, we obtain evidence that renewable energy has a negative effect on volatility at the highest quantiles. Overall, our analysis indicates that policy reforms can help accelerate the green transition while minimizing the volatility in electricity prices.

---

### Research Interests

I study labor economics, economics of education, and industrial organization. Methodologically, I combine tools from empirical industrial organization, causal inference, and Bayesian econometrics to understand how micro-level behaviors aggregate into broader economic outcomes.
