...
This site is built with [Jekyll](https://jekyllrb.com/) using the Minima theme and hosted on [GitHub Pages](https://pages.github.com/). The design is inspired by academic economist sites such as [Alex Bartik's](https://www.alexbartik.com/) and ideas from [Jonathan McGlone](https://github.com/jmcglone/jmcglone.github.io) and [Paul Goldsmith-Pinkham](https://github.com/paulgp/paulgp.github.io).
